...
public class SubsidiaryTable extends Table {
	...
	// private static final String[] itemNames1 = { "本月", "去年同期", "增減金額",
	// "增減百分比",
	// "本年累計", "去年累計", "增減金額", "增減百分比", "備註" };
	// private static final String[] itemNames2 = { "本月", "去年同期", "增減金額",
	// "增減百分比",
	...
	// MonthlyOperatingIncome monthlyOperatingIncome = new
	...
	// this.cumulativeExchangeRateOfCurrentYear =
	// cumulativeExchangeRateOfCurrentYear;
	// this.comment = comment;
	// }
	//
